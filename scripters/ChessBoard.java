...
public class Board {
	...
	public int[] GetMovesFromTeam(int team, int[] board) {
		...
		for(int y = 0; y < 8; y++) for(int x = 0; x < 8; x++) {
			...
			//System.out.println(piece & 0b1111);
			//UtilsText.PrintMoves(m, "`123567890");
	...
	public boolean IsPromoting() { return IsPromoting; }
